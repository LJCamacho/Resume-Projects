...
public class Character extends Entity{
	...
	public Character(BufferedImage image, int x, int y, int v, int w, int h, int c) {
	...
	public int gravityFall (ArrayList<Character> bruh) {
		for (Character bk: bruh) 
	...
	public int collidesWith(Character c) {
